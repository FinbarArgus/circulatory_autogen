...
Circulatory Autogen provides a script to convert an existing cellml model to a format that can be used in this software. You can find the script **"generate_modules_files.py"** at `[CA_dir]/src/scripts`. 
