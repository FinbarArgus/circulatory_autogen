...
axs[0,0].plot(t, y[0][0]*conversion)#, label='LPA_A/u')
axs[0,1].plot(t, y[1][0]*conversion)#, label='RPA_A/u')
axs[1,0].plot(t, y[2][0]*conversion)#, label='LPV_V/u')
axs[1,1].plot(t, y[3][0]*conversion)#, label='heart/u_rv')
