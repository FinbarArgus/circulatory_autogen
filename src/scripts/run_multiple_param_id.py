...
if __name__ == '__main__':
    ...
    try:
        ...
        obs_files = ['lv_estimation_observables_BB016.json',
                'lv_estimation_observables_BB044.json',
        ...
        const_files = ['lv_estimation_constants_BB016.json',
                'lv_estimation_constants_BB044.json',
